...
telefon = Telefon("Iphone", 15000, 2020, 4000, 128)
print(telefon.numele)
print(telefon.pretul)
print(telefon.anul_producerii)
print(telefon.baterie_mAh)
print(telefon.memorie_GB)

telefon.upgrade_memory(256)
telefon.upgrade_battery(5000)
...
laptop = Laptop("Dell", 2000, 2021, "Windows 10", "Intel i5")
print(laptop.numele)
print(laptop.pretul)
print(laptop.anul_producerii)
print(laptop.sistem_de_operare)
print(laptop.procesor)

laptop.upgrade_processor("Intel i7")
laptop.upgrade_os("Windows 11")
...
trotineta = Trotineta("Xiaomi M365", 500, 2022, 25, 30)
print(trotineta.numele)
print(trotineta.pretul)
print(trotineta.anul_producerii)
print(trotineta.viteza_maxima)
print(trotineta.autonomie_km)

trotineta.upgrade_speed(30)
trotineta.upgrade_autonomy(40)
