...
class Sistem:
    ...
    def adauga_utilizator(self, utilizator):
        self.__utilizatori[len(self.__utilizatori) + 1] = utilizator
    ...
    def modifica_name_user(self, id_utilizator, new_name):
        if id_utilizator in self.__utilizatori:
            self.__utilizatori[id_utilizator].set_nume(new_name)
            return f"Numele utilizatorului cu id-ul {id_utilizator} a fost modificat cu succes."
        else:
            return "Utilizatorul nu există."
    ...
    def sterge_utilizator(self, id_utilizator):
        if id_utilizator in self.__utilizatori:
            ...
            return f"Utilizatorul cu id-ul {id_utilizator} a fost șters cu succes."
        else:
            return "Utilizatorul nu există."

    def modifica_nivel_acces(self, id_utilizator, new_access_level):
        if id_utilizator in self.__utilizatori:
            self.__utilizatori[id_utilizator].set_nivel_acces(new_access_level)
            return f"Nivelul de acces al utilizatorului cu id-ul {id_utilizator} a fost modificat cu succes."
        else:
            return "Utilizatorul nu există."
...
class TechSolutionsApp:
    ...
    def __init__(self, versiune):
        self.versiune_aplicatie = versiune
